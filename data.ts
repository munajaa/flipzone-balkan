...
export const VENDORS_DATA = [
  ...
  {
    id: "niketechtleece",
    name: "Nike Tech Fleece Dobavljač",
  ...
  {
    id: "nintendoswitch",
    name: "Nintendo Switch Dobavljač",
  ...
  {
    id: "nikeairforce1",
    name: "Nike Air Force 1 Dobavljač",
...
export const MARQUEE_SALES = [
  "Marko je upravo zaradio €120", 
  "Novi VIP član se pridružio", 
  "AirPods dobavljač je ažuriran", 
  "Ivana skalira na €500 dnevno", 
  "Sretan Reselling Balkan!", 
  "Luka: 'Ovo je promijenilo sve!'"
];
