    ...
    <div class="reveal relative flex flex-col group bg-white/[0.01] border border-white/5 rounded-[2rem] overflow-hidden hover:border-accent1/30 transition-all duration-500 hover:bg-white/[0.03] hover:-translate-y-1">
      <div class="relative aspect-square w-full p-8 flex items-center justify-center bg-gradient-to-b from-white/[0.03] to-transparent overflow-hidden">
        ...
        <div class="absolute top-5 left-5 flex flex-col gap-2 z-20">
          ...
          ${v.allVendors ? `<span class="px-3 py-1 bg-accent1 text-brandBg text-[8px] font-black uppercase tracking-[0.2em] rounded-full shadow-[0_0_20px_rgba(110,231,183,0.5)] animate-pulse"><i class="fa-solid fa-star"></i> Svi dobavljači (26+)</span>` : ''}
      ...
      <div class="p-6 pt-2 flex flex-col flex-1">
        ...
        ${v.allVendors ? `
          <div class="mb-4 space-y-1 text-[9px] text-accent1/80">
            <div class="flex items-center gap-2"><i class="fa-solid fa-check-circle text-accent1 text-[10px]"></i> 26+ Premium izvora</div>
            <div class="flex items-center gap-2"><i class="fa-solid fa-check-circle text-accent1 text-[10px]"></i> Svi dobavljači dostupni</div>
            <div class="flex items-center gap-2"><i class="fa-solid fa-check-circle text-accent1 text-[10px]"></i> 24/7 podrška</div>
          </div>
        ` : ''}
